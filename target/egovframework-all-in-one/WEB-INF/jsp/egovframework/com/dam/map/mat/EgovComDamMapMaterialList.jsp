...
<html lang="ko">
	<head>
		 ...
		 ******************************************************** */
		function fnRegist(){
			location.href = "<c:url value='/dam/map/mat/EgovComDamMapMaterialRegist.do'/>";
		}
		-->
		</script>
	</head>
				...
				<table width="100%" cellpadding="8" class="table-search" border="0">
		 			<tr>
		  				<td width="30%" class="title_left">
		   				<h1><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;지식맵(유형별) 목록</h1>
		   				</td>
		  				<td width="20%">
