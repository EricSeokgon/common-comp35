				...
				<table width="100%" cellpadding="8" class="table-search" border="0">
		 			<tr>
		  				<td width="30%" class="title_left">
		   				<h1><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" align="middle"  alt="">&nbsp;지식맵(조직별) 목록</h1>
		   				</td>
		  				<th></th>
		  				<td width="20%">
		  				...
		  				<th width="20%">
		   					<table border="0" cellspacing="0" cellpadding="0">
		    					<tr> 
								    ...
								    <td class="btnBackground"><a href="<c:url value='/dam/map/tea/EgovComDamMapTeamRegist.do'/>"><spring:message code="button.create" /></a></td>
