...
<table border="0">
  <tr>
    ...
    <table width="100%" cellpadding="1" class="table-register" summary="장애처리에 대한 결과를 등록한다.">
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>장애ID<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
        <td class="lt_text" nowrap><c:out value='${troblProcess.troblId}'/></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>장애명<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
        <td class="lt_text" nowrap><c:out value='${troblProcess.troblNm}'/></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>장애종류<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
        <td class="lt_text" nowrap><c:out value='${troblProcess.troblKndNm}'/></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>장애설명<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>장애발생시간<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
        <td class="lt_text" nowrap><c:out value='${troblProcess.troblOccrrncTime}'/></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>장애등록자<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
        <td class="lt_text" nowrap><c:out value='${troblProcess.troblRqesterNm}'/></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>장애요청시간<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
        <td class="lt_text" nowrap><c:out value='${troblProcess.troblRequstTime}'/></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>처리상태<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
    ...
    <table width="100%" cellpadding="1" class="table-register">
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>처리결과<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>처리시간<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
        <td class="lt_text" nowrap>
            ...
            <a href="#LINK" onClick="javascript:fn_egov_NormalCalendar(document.troblProcess, document.troblProcess.troblProcessDate, document.troblProcess.troblProcessD);" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/com/sym/cal/bu_icon_carlendar.gif'/>" title="새창" alt="달력창팝업버튼이미지"></a>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>처리자<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
