...
<form:form commandName="ntwrkSvcMntrngVO" name="ntwrkSvcMntrngVO" method="post" action="${pageContext.request.contextPath}/utl/sys/nsm/modifyNtwrkSvcMntrng.do">
	...
	<tbody>
	  <tr> 
		<th scope="row" width="20%" height="23" class="required_text" nowrap >시스템IP<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
		<td width="80%" >
	  ...
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap >시스템포트<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
	      <c:out value="${ntwrkSvcMntrngVO.sysPort}" escapeXml="false" />
	    </td>
	  </tr>
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap >시스템명<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
