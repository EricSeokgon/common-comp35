...
<form:form commandName="fileSysMntrngVO" name="fileSysMntrngVO" method="post" action="${pageContext.request.contextPath}/utl/sys/fsm/insertFileSysMntrng.do">
	...
	<tbody>
	  <tr> 
		<th scope="row" width="20%" height="23" class="required_text" nowrap ><label for="fileSysNm">파일시스템명</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
		<td width="80%" >
	  ...
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap ><label for="fileSysManageNm">파일시스템관리명</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
	  ...
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap ><label for="fileSysMg">파일시스템 크기</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
	  ...
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap ><label for="fileSysThrhld">파일시스템 임계치</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
	  ...
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap ><label for="mngrNm">관리자명</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
	  ...
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap ><label for="mngrEmailAddr">관리자이메일주소</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
