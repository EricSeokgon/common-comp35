...
<form:form commandName="ntwrkSvcMntrngLogVO" name="ntwrkSvcMntrngLogVO" method="post" action="${pageContext.request.contextPath}/utl/sys/nsm/selectNtwrkSvcMntrngLogList.do">
	...
	<tbody>
	  ...
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap >모니터링상태<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
	  ...
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap >로그정보<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="선택항목"></th>
	    <td width="80%" >
	  ...
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap >생성일시<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
