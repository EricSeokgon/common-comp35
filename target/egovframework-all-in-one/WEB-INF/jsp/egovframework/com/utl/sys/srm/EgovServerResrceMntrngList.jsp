 ...
 <tr>
  ...
  <td width="440"><label for="strServerNm">서버H/W 명 : </label><input name="strServerNm" id="strServerNm" type="text" value="<c:out value="${serverResrceMntrngVO.strServerNm}"/>" size="8" title="검색" onkeypress="press();" >
                  <label for="strStartDt">기간 : </label><input type="text" name="strStartDt" id="strStartDt" value="<c:out value='${pmServerResrceMntrng.strStartDt}'/>" size="10" maxlength="10" title="서버자원 모니터링 시작일자" >
                        ...
                        <a href="#LINK" onClick="javascript:fn_egov_NormalCalendar(document.listForm, document.listForm.strServerResrceMntrngDate, document.listForm.strStartDt);" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/com/sym/cal/bu_icon_carlendar.gif'/>" title="새창" alt="달력창팝업버튼이미지"></a>
                        ~ <input type="text" name="strEndDt" id="strEndDt" value="<c:out value='${pmServerResrceMntrng.strEndDt}'/>" size="10" maxlength="10" title="서버자원 모니터링 종료일자" >
                          <a href="#LINK" onClick="javascript:fn_egov_NormalCalendar(document.listForm, document.listForm.strServerResrceMntrngDate, document.listForm.strEndDt);" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/com/sym/cal/bu_icon_carlendar.gif'/>" title="새창" alt="달력창팝업버튼이미지"></a>
