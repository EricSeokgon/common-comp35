		...
		<DIV id="content" style="width:712px">
			...
			<form:hidden path="sysId"/>	
				...
				<table width="700" cellpadding="8" class="table-search" border="0">
				 	<tr>
				  		<td width="100%"class="title_left">
				   		<h1><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" align="absmiddle" alt="">&nbsp;HTTP모니터링 수정</h1></td>
				 	</tr>
				</table>
				...
				<caption>HTTP모니터링 수정</caption>
  					<tr>
    					<th scope="row" width="20%" height="23" class="required_text" nowrap>웹서비스종류<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
	    				<td>
				  	...
				  	<tr>
				    	<th scope="row" width="20%" height="23" class="required_text" nowrap>시스템URL<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
				    	<td width="80%">
				  	...
				  	<tr>
				    	<th scope="row" width="20%" height="23" class="required_text" nowrap>관리자명<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
				    	<td width="80%">
				  	...
				  	<tr>
				  		<th scope="row" width="20%" height="23" class="required_text" nowrap>관리자이메일<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
				    	<td width="80%">
