			...
			<form name="Form" action="" method="post">
				<input name="sysId" type="hidden">
					<table width="700" cellpadding="8" class="table-search" border="0">
			 			<tr>
			  				<td width="100%" class="title_left">
			   				<h1><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" align="absmiddle" alt="">&nbsp;HTTP모니터링 상세조회</h1></td>
			 			</tr>
					</table>
					...
					<caption>HTTP모니터링 상세조회</caption>
					  	...
					  	<tr>
					    	<th scope="row" width="20%" height="23" class="required_text">시스템URL<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
