...
<div class="title_left" style="width:100%;margin:0 0 0 0;">
	<h1><img src="<c:url value="/images/egovframework/com/cmm/icon/tit_icon.gif"/>" width="16" height="16" hspace="3" style="vertical-align:middle; display:inline-block;" alt=" ">&nbsp;RSS태그관리 수정</h1>
</div>
...
<tr> 
	<th scope="row" width="20%" height="23" class="required_text"><label for="trgetSvcNm">대상서비스명</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th>
	<td width="80%">
...
<tr> 
	<th scope="row" width="20%" height="23" class="required_text"><label for="trgetSvcTable">대상테이블명</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th>
	<td width="80%">
...
<tr> 
	<th scope="row" width="20%" height="23" class="required_text"><label for="trgetSvcListCo">대상서비스목록갯수</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th>
	<td width="80%">
...
<tr> 
	<th scope="row" width="20%" height="23" class="required_text"><label for="hderTitle">헤더TITLE</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th>
	<td width="80%">
...
<tr> 
	<th scope="row" width="20%" height="23" class="required_text"><label for="hderLink">헤더LINK</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th>
	<td width="80%">
...
<tr> 
	<th scope="row" width="20%" height="23" class="required_text"><label for="hderDescription">헤더DSCRIPTION</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th>
	<td width="80%">
...
<tr> 
	...
	<tr> 
		<th scope="row" width="30%" height="23" class="required_text"><label for="bdtTitle">본문TITLE</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th>
		<td width="80%">
		<a href="#LINK" onClick="fn_egov_ColumnSetting_RssTagManage('bdtTitle')"><img src="<c:url value='/images/egovframework/com/cmm/button/btn_regist.gif'/>" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 0px 0px 2px; " alt="컬럼명추가" title="컬럼명추가"></a>
		<form:input path="bdtTitle" size="73" title="본문TITLE" cssClass="txaIpt90" maxlength="255"/>
		<a href="#LINK" onClick="document.getElementById('bdtTitle').value='';"><img src="<c:url value='/images/egovframework/com/cmm/button/btn_delete.gif'/>" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 2px 0px 0px; " alt="컬럼명삭제" title="컬럼명삭제"></a>
		<div><form:errors path="bdtTitle" cssClass="error"/></div>
		</td>
	</tr>
	<tr> 
		<th scope="row" height="23" class="required_text"><label for="bdtLink">본문LINK</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th>
		<td>
		<a href="#LINK" onClick="fn_egov_ColumnSetting_RssTagManage('bdtLink')"><img src="<c:url value='/images/egovframework/com/cmm/button/btn_regist.gif'/>" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 0px 0px 2px; " alt="컬럼명추가" title="컬럼명추가"></a>	
		<form:input path="bdtLink" size="73" title="본문LINKE" cssClass="txaIpt90" maxlength="255"/>
		<a href="#LINK" onClick="document.getElementById('bdtLink').value='';"><img src="<c:url value='/images/egovframework/com/cmm/button/btn_delete.gif'/>" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 2px 0px 0px; " alt="컬럼명삭제" title="컬럼명삭제"></a>
		<div><form:errors path="bdtLink" cssClass="error"/></div>
		</td>
	</tr>
	<tr> 
		<th scope="row" height="23" class="required_text"><label for="bdtDescription">본문DESCRIPTION</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th>
		<td>
		<a href="#LINK" onClick="fn_egov_ColumnSetting_RssTagManage('bdtDescription')"><img src="<c:url value='/images/egovframework/com/cmm/button/btn_regist.gif'/>" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 0px 0px 2px; " alt="컬럼명추가" title="컬럼명추가"></a>
		<form:input path="bdtDescription" size="73" title="본문DESCRIPTION" cssClass="txaIpt90" maxlength="255"/>
		<a href="#LINK" onClick="document.getElementById('bdtDescription').value='';"><img src="<c:url value='/images/egovframework/com/cmm/button/btn_delete.gif'/>" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 2px 0px 0px; " alt="컬럼명삭제" title="컬럼명삭제"></a>
	...
	<tr> 
		...
		<td>
		<a href="#LINK" onClick="fn_egov_ColumnSetting_RssTagManage('bdtTag')"><img src="<c:url value='/images/egovframework/com/cmm/button/btn_regist.gif'/>" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 0px 0px 2px; " alt="컬럼명추가" title="컬럼명추가"></a>
		<form:input path="bdtTag" size="73" title="본문TAG" cssClass="txaIpt90" maxlength="255"/>
		<a href="#LINK" onClick="document.getElementById('bdtTag').value='';"><img src="<c:url value='/images/egovframework/com/cmm/button/btn_delete.gif'/>" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 2px 0px 0px; " alt="컬럼명삭제" title="컬럼명삭제"></a>
...
<tr> 
  ...
  <th scope="col">&nbsp;</th>
  <td><img src="<c:url value='/images/egovframework/com/cmm/btn/bu2_left.gif'/>"  width="8" height="20" alt="버튼이미지"></td>
  <td class="btnBackground" nowrap><a href="<c:url value='/uss/ion/rss/listRssTagManage.do'/>"><spring:message code="button.list" /></a> 
  </td>
  <td><img src="<c:url value='/images/egovframework/com/cmm/btn/bu2_right.gif'/>"  width="8" height="20" alt="버튼이미지"></td>        
</tr>
</table>
