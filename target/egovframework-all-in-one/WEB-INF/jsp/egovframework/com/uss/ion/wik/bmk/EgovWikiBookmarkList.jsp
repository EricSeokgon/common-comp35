...
<link type="text/css" rel="stylesheet" href="<c:url value='/images/egovframework/com/cmm/button.css'/>">
...
function fn_egov_search_RssTagManage(){
	...
	vFrom.action = "<c:url value='/uss/ion/wik/bmk/listWikiBookmark.do'/>";
	vFrom.submit();
