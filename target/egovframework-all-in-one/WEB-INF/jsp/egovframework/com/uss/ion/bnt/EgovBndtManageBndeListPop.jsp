...
<script type="text/javaScript" language="javascript">
	...
	function fncBndtManageBndeCheck(){
	   if(checkFile()){
		   document.listForm.action ="<c:url value='/uss/ion/bnt/EgovBndtManageListPop.do'/>";
	...
	<table width="670" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="40%"class="title_left">
	      <h1><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;당직일괄등록</h1></td>
	  <th>
	  </th>
	  <td width="10%"></td>
	  <td width="35%"></td>
