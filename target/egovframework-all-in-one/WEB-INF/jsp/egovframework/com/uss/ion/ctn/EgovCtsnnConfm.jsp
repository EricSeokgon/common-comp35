...
<script type="text/javaScript" language="javascript">
	 ...
	 ******************************************************** */
	 function fncConfmCtsnnManage(){
		...
		window.showModalDialog("<c:url value='/uss/ion/ism/EgovConfmPopup.do'/>", arrParam,"dialogWidth=780px;dialogHeight=170px;resizable=yes;center=yes", showModalDialogfncConfmCallback);
	 }
	 ...
	 ******************************************************** */
	 function fncReturnCtsnnManage(){
		...
		window.showModalDialog("<c:url value='/uss/ion/ism/EgovReturnPopup.do'/>", arrParam,"dialogWidth=780px;dialogHeight=170px;resizable=yes;center=yes", showModalDialogfncReturnCtsnnManageCallback);
	 }
...
<caption>소속정보</caption>
  <tr>
    <th width="20%" height="23" class="required_text"  >신청자<img src="<c:url value='/images/egovframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt=""></th>          
    <td width="30%"><c:out value='${ctsnnManageVO.usNm}'/></td>
    <th width="20%" height="23" class="required_text"  >소속<img src="<c:url value='/images/egovframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt=""></th>          
...
<caption>경조승인</caption>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">경조명<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td colspan="3"><c:out value='${ctsnnManageVO.ctsnnNm}'/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">경조구분<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%"><c:out value='${ctsnnManageVO.ctsnnCdNm}'/></td>
    <th width="20%" height="23" class="required_text"  scope="row">발생일<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%"><c:out value='${ctsnnManageVO.occrrDe}'/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">대상자명<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td colspan="3"><c:out value='${ctsnnManageVO.trgterNm}'/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">관계<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%"><c:out value='${ctsnnManageVO.relateNm}'/></td>
    <th width="20%" height="23" class="required_text" scope="row">생년월일<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%"><c:out value='${ctsnnManageVO.brth}'/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">비고<img src="<c:url value='/images/egovframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt=""></th>          
    <td colspan="3">
