...
<!-- 등록폼 시작  -->
<form:form commandName="noteManage" name="noteManage" method="post" enctype="multipart/form-data" >
<%-- 상산 타이틀 --%>
<div class="title_left" style="width:100%;margin:0 0 0 0;">
<h1><img src="<c:url value="/images/egovframework/com/cmm/icon/tit_icon.gif"/>" width="16" height="16" hspace="3" style="vertical-align:middle; display:inline-block;" alt=" ">&nbsp;쪽지 관리(보내기)</h1>
</div>
