...
<caption>행사관리 수정</caption>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">행사구분<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%"  colspan="3"><c:out value='${eventManageVO.eventTemp3}'/></td>
  </tr> 
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row">행사명<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
