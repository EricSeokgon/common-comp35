...
<tr>
	<th scope="row" width="20%" height="23" class="required_text">첨부파일<img src="<c:url value='/images/egovframework/com/cmm/icon/no_required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th>
	<td width="80%">
