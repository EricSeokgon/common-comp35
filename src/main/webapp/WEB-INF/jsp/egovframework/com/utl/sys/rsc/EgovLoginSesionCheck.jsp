...
<table border="0">
  <tr>
    ...
    <table width="100%" cellpadding="8" class="table-line" summary="로그인 세션정보를 설정 및 체크한다.">
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>URL<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
        <td class="lt_text" nowrap><label for="url"><input name="url" id="url" type="text" maxLength="1000" size="80" ></label></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>세션 URL<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
