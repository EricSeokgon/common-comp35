...
<form:form commandName="fileSysMntrngLogVO" name="fileSysMntrngLogVO" method="post" action="${pageContext.request.contextPath}/utl/sys/fsm/selectFileSysMntrngLogList.do">
	...
	<tbody>
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap >로그ID<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
	      <c:out value="${fileSysMntrngLog.logId}" escapeXml="false" />
	    </td>
	  </tr>
	  <tr> 
		<th scope="row" width="20%" height="23" class="required_text" nowrap >파일시스템명<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
		<td width="80%" >
			<c:out value='${fileSysMntrngLog.fileSysNm}'/>
		</td>
	  </tr>
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap >파일시스템관리명<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
	      <c:out value='${fileSysMntrngLog.fileSysManageNm}'/>
	    </td>
	  </tr>
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap >파일시스템 크기<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
	      <c:out value='${fileSysMntrngLog.fileSysMg}'/>G
	    </td>
	  </tr>
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap >파일시스템 임계치<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
	      <c:out value='${fileSysMntrngLog.fileSysThrhldRt}'/>% (<c:out value='${fileSysMntrngLog.fileSysThrhld}'/>G)
	    </td>
	  </tr>
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap >파일시스템 사용량<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
	      <c:out value='${fileSysMntrngLog.fileSysUsgRt}'/>% (<c:out value='${fileSysMntrngLog.fileSysUsgQty}'/>G)
	    </td>
	  </tr>
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap >모니터링상태<img src="<c:url value='/images/egovframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt="선택항목"></th>
	    <td width="80%" >
	  ...
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap >로그정보<img src="<c:url value='/images/egovframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt="선택항목"></th>
	    <td width="80%" >
	  ...
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap >생성일시<img src="<c:url value='/images/egovframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt="선택항목"></th>
	    <td width="80%" >
