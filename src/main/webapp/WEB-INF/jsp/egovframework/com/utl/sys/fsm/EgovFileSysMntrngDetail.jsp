...
<form:form commandName="fileSysMntrngVO" name="fileSysMntrngVO" method="post" action="${pageContext.request.contextPath}/utl/sys/fsm/modifyFileSysMntrng.do">
	...
	<tbody>
	  ...
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap >관리자명<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
	      <c:out value='${fileSysMntrngVO.mngrNm}'/>
	    </td>
	  </tr>
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap >관리자이메일주소<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
	      <c:out value='${fileSysMntrngVO.mngrEmailAddr}'/>
	    </td>
	  </tr>
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap >모니터링상태<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="선택항목"></th>
	    <td width="80%" >
	      <c:out value="${fileSysMntrngVO.mntrngSttus}" />
	    </td>
	  </tr>
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap >마지막 생성일시<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="선택항목"></th>
	    <td width="80%" >
