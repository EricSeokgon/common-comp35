...
<td height="60">
	...
	<tr>
		...
		<td>
			...
			<a href="#LINK" onClick="location.href='<c:url value='/uss/ion/bnt/EgovBndtManageList.do'/>?year=<%=year-1%>&amp;month=<%=month%>'"><img src="<c:url value='/images/egovframework/com/cmm/icon/icoPrev.gif'/>" alt="연도 이전" style="margin-right:4px;border:0px;"></a>
			<font size='3'><b><%=year%>년</b></font>
			<a href="#LINK" onClick="location.href='<c:url value='/uss/ion/bnt/EgovBndtManageList.do'/>?year=<%=year+1%>&amp;month=<%=month%>'"><img src="<c:url value='/images/egovframework/com/cmm/icon/icoNxt.gif'/>"  alt="연도 이후" style="margin-left:4px;border:0px;"></a>
			</td>
			<td width="100" align="center">
			<%if(month > 0 ){ %>
			<a href="#LINK" onClick="location.href='<c:url value='/uss/ion/bnt/EgovBndtManageList.do'/>?year=<%=year%>&amp;month=<%=month-1%>'"><img src="<c:url value='/images/egovframework/com/cmm/icon/icoPrev.gif'/>" alt="월 이전" style="margin-right:4px;border:0px;"></a>
			<%}%>
			<font size='3'><b><%=month+1%>월</b></font>
			<%if(month < 11 ){ %>
			<a href="#LINK" onClick="location.href='<c:url value='/uss/ion/bnt/EgovBndtManageList.do'/>?year=<%=year%>&amp;month=<%=month+1%>'"><img src="<c:url value='/images/egovframework/com/cmm/icon/icoNxt.gif'/>"  alt="월 이후" style="margin-left:4px;border:0px;"></a>
			<%}%>
			</td>
			</tr>
			</table>
		...
		<td width="200">
		<span class="button"><a href="<c:url value='/uss/ion/bnt/EgovBndtManageListPop.do'/>" target="_blank" title="새 창으로 이동" onclick="fncBndtManageBnde(); return false;">당직엑셀등록</a></span>
		</td>
	</tr>
	</table>
