...
<caption>휴가승인/반려</caption>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">휴가구분<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td colspan="3"><c:out value='${vcatnManageVO.vcatnSeNm}'/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">시작일자<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%"><c:out value='${vcatnManageVO.bgnde}'/></td>
    <c:if test="${vcatnManageVO.vcatnSe ne '02' }">
    <th width="20%" height="23" class="required_text" scope="row">종료일자<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%"  ><c:out value='${vcatnManageVO.endde}'/></td>
    </c:if>
    <c:if test="${vcatnManageVO.vcatnSe eq '02' }">
    <th width="20%" height="23" class="required_text" scope="row" >정오구분<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">휴가사유<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td colspan="3">
