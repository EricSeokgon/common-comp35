...
<div class="title_left" style="width:100%;margin:0 0 0 0;">
	<h1><img src="<c:url value="/images/egovframework/com/cmm/icon/tit_icon.gif"/>" width="16" height="16" hspace="3" style="vertical-align:middle; display:inline-block;" alt=" ">&nbsp;RSS태그관리 등록</h1>
</div>
...
<tr> 
	...
	<tr> 
		...
		<td width="80%">
		<a href="#LINK" onClick="fn_egov_ColumnSetting_RssTagManage('bdtTitle')"><img src="<c:url value='/images/egovframework/com/cmm/icon/action_add.gif'/>" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 0px 0px 2px; " alt="컬럼명추가" title="컬럼명추가"></a>
	...
	<tr> 
		...
		<td>
		<a href="#LINK" onClick="fn_egov_ColumnSetting_RssTagManage('bdtLink')"><img src="<c:url value='/images/egovframework/com/cmm/icon/action_add.gif'/>" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 0px 0px 2px; " alt="컬럼명추가" title="컬럼명추가"></a>	
		<form:input path="bdtLink" size="73" title="본문LINKE" cssClass="txaIpt90" maxlength="255"/>
		<a href="#LINK" onClick="document.getElementById('bdtLink').value='';"><img src="<c:url value='/images/egovframework/com/cmm/icon/action_delete.gif'/>" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 2px 0px 0px; " alt="컬럼명삭제" title="컬럼명삭제"></a>
	...
	<tr> 
		...
		<td>
		<a href="#LINK" onClick="fn_egov_ColumnSetting_RssTagManage('bdtDescription')"><img src="<c:url value='/images/egovframework/com/cmm/icon/action_add.gif'/>" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 0px 0px 2px; " alt="컬럼명추가" title="컬럼명추가"></a>
		<form:input path="bdtDescription" size="73" title="본문DESCRIPTION" cssClass="txaIpt90" maxlength="255"/>
		<a href="#LINK" onClick="document.getElementById('bdtDescription').value='';"><img src="<c:url value='/images/egovframework/com/cmm/icon/action_delete.gif'/>" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 2px 0px 0px; " alt="컬럼명삭제" title="컬럼명삭제"></a>
	...
	<tr> 
		...
		<td>
		<a href="#LINK" onClick="fn_egov_ColumnSetting_RssTagManage('bdtTag')"><img src="<c:url value='/images/egovframework/com/cmm/icon/action_add.gif'/>" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 0px 0px 2px; " alt="컬럼명추가" title="컬럼명추가"></a>
