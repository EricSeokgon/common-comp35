...
<script type="text/javaScript" language="javascript" defer="defer">
	...
	*/
		...
		arrParam[0] = window;
		arrParam[1] = '기념일일괄처리';
	 	window.showModalDialog("<c:url value='/uss/ion/ans/EgovAnnvrsryManageListPop.do'/>", arrParam,"dialogWidth=750px;dialogHeight=500px;resizable=yes;center=yes");
	}
  ...
  <th width="10%" align="right">
       <table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td>&nbsp;&nbsp;</td>
          <td><span class="button"><a href="<c:url value='/uss/ion/ans/EgovAnnvrsryManageListPop.do'/>" target="_blank" title="새 창으로 이동" onclick="fncAnnvrsryManageBnde(); return false;">기념일엑셀등록</a></span></td>
        </tr>
       </table>
  </th>  
 </tr>
...
<caption>기념일관리목록 검색조건</caption>
  <tr> 
    <th width="20%" height="23" scope="row" class="required_text"><label for="searchKeyword">년도</label><img src="<c:url value='/images/egovframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt=""></th>
    <td width="80%">
