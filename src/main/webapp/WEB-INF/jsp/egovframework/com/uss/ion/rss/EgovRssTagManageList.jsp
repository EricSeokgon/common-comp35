...
<tr>
	...
	<h1><img src="<c:url value="/images/egovframework/com/cmm/icon/tit_icon.gif"/>" width="16" height="16" hspace="3" style="vertical-align:middle; display:inline-block;" alt=" ">&nbsp;RSS태그관리 목록조회</h1>
	</th>
	<td width="110px">
	...
	<tr>
		...
		<td><img src="<c:url value="/images/egovframework/com/cmm/btn/bu2_right.gif"/>" width="8" height="20" alt="버튼이미지"></td>
		<td>&nbsp;</td>
		<td><img src="<c:url value="/images/egovframework/com/cmm/btn/bu2_left.gif"/>"  width="8" height="20"></td>
      	<td class="btnBackground" nowrap><a href="<c:url value='/uss/ion/rss/registRssTagManage.do'/>?pageIndex=<c:out value='${searchVO.pageIndex}'/>"><spring:message code="button.create" /></a>
      	<td><img src="<c:url value="/images/egovframework/com/cmm/btn/bu2_right.gif"/>" width="8" height="20" alt="버튼이미지"></td>
	</tr>
	</table>
	</th>
