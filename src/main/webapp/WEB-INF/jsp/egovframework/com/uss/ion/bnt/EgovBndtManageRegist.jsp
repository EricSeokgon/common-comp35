...
<caption>당직 등록</caption>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="bndtId">당직자명</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%" >
      <input name="bndtIdName" id="bndtIdName" type="text" title="당직자명" readonly/>
      <form:hidden  path="bndtId"/>
      <form:errors path="bndtId"/>
	<a href="<c:url value='/uss/ion/ism/selectSanctnerListPopup.do'/>" target="_blank"  title="새 창으로 이동"  onClick="fn_egov_schdulCharger_LeaderSchdule_Bndt('당직 대상자', 'bndtId', '', 'bndtIdName', 'orgnztNm');return false;">
	<img src="<c:url value='/images/egovframework/com/cmm/search2.gif'/>" style="border:0px" alt="당직" title="당직">
	</a>
    </td>
  </tr> 
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="orgnztNm">소속</label><img src="<c:url value='/images/egovframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt=""></th>
    <td width="80%">
        <input name="orgnztNm" id="orgnztNm" type="text" title="소속" class="readOnlyClass" readonly>
    </td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="bndtDe">당직일자</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%">
