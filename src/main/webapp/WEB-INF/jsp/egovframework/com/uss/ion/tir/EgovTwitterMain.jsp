...
function fn_egov_popupOpen_Init(){
	...
	fn_egov_popupOpen_TwitterMain('<c:url value='/uss/ion/tir/selectTwitterPopup.do'/>?cmd=<egovc:out value="<%=sCmd%>"/>','TwitterPopupAuth',900,600);
}
...
<div class="title_left" style="width:100%;margin:0 0 0 0;">
	<h1><img src="<c:url value="/images/egovframework/com/cmm/icon/tit_icon.gif"/>" width="16" height="16" hspace="3" style="vertical-align:middle; display:inline-block;" alt=" ">&nbsp;트위터  수신(목록)-인증</h1>
</div>
<%}else{%>
<div class="title_left" style="width:100%;margin:0 0 0 0;">
	<h1><img src="<c:url value="/images/egovframework/com/cmm/icon/tit_icon.gif"/>" width="16" height="16" hspace="3" style="vertical-align:middle; display:inline-block;" alt=" ">&nbsp;트위터 송신(등록)-인증</h1>
</div>
<%}%>
<br>
