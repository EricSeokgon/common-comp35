...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="9" height="9" hspace="3" alt="">&nbsp;휴가 신청자</td>
 </tr>
</table>
...
<caption>휴가관리 수정</caption>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="vcatnSe">휴가구분</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td colspan="3">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="bgnde">시작일자</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%">
    ...
    <th width="20%" height="23" class="required_text"   scope="row"><span id="nameSpan"><label for="endde">종료일자</label></span><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%"  >
    	<span id="noonSeSpan"> 
	      <input type="hidden" name="cal_url" value="<c:url value='/sym/cal/EgovNormalCalPopup.do'/>" />
    ...
    <th width="20%" height="23" class="required_text"   scope="row"><span id="nameSpan"><label for="noonSe">정오구분</label></span><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%">
        <span id="noonSeSpan">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="vcatnResn">휴가사유</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td colspan="3">
...
<input type="hidden" name="sanctnDtNm" value="승인권자" />
<!-- //결재권자 정보 Include -->
