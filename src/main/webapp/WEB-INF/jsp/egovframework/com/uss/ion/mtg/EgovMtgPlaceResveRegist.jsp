...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%"class="title_left">
    <h1><img src="<c:url value='/images/egovframework/com/uss/ion/mtg/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;회의실 예약신청</h1></td>
  <td width="50%">&nbsp;</td>
